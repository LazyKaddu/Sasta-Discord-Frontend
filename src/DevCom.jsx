...
const DevComSection = () => {
  ...
  return (
    <>
      <div className="size-full bg-red-400 overflow-y-auto ">
        <div className="relative size-full bg-[url('https://image.freepik.com/free-vector/spot-light-background_1284-4685.jpg')] bg-cover ">
          <div className="w-[65%] absolute top-[60%] left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center text-3xl font-semibold text-zinc-800 tracking-wide opacity-95 flex justify-center items-center flex-col">
            ...
            mt-4 py-2 px-3 rounded-full hover:text-yellow-500 hover:bg-white border-2 border-yellow-500 tracking-normal transition"
              onClick={Navigate}
            >
